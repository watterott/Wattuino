 ...
 */
  ...
  { PORTA,  3, PIO_ANALOG,  (PIN_ATTR_DIGITAL                                ), ADC_Channel1,   NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE }, // DAC/VREFP
 ...
 */
  ...
  { PORTA, 30, PIO_DIGITAL,    (PIN_ATTR_NONE                                ), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },
  { PORTA, 31, PIO_DIGITAL,    (PIN_ATTR_NONE                                ), No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },
};
...
void initVariant()
{
  //disable peripheral multiplexing for SWCLK + SWDIO
  PORT->Group[g_APinDescription[36].ulPort].PINCFG[g_APinDescription[36].ulPin].bit.PMUXEN = 0;
  PORT->Group[g_APinDescription[37].ulPort].PINCFG[g_APinDescription[37].ulPin].bit.PMUXEN = 0;
}
