...
#define _VIRTUALFAT_H_
	...
	/* Macros: */
		...
		#define FLASH_FILE_SIZE_BYTES     (FLASH_SIZE - APP_START_ADDRESS)

		/** Number of sectors that comprise a single logical disk cluster. */
		#define SECTOR_PER_CLUSTER        4

		/** Size of a single logical sector on the disk. */
		#define SECTOR_SIZE_BYTES         VMEM_SECTOR_SIZE
	...
	/* Function Prototypes: */
			...
			//static void UpdateFAT12ClusterChain(const uint16_t StartIndex,
